...
HEART_COLOR = 'blue'
COLOR_SET = ['red', 'orange', 'yellow', 'green', 'cyan', 'blue', 'purple']
IMAGE_ENLARGE = CANVAS_HEIGHT / 50
...
class Heart:
    ...
    def render_multicolor(self, render_canvas, render_frame):
        cursor, color_num = 0, len(COLOR_SET)
        for x, y, size in self.all_points[render_frame % self.generate_frame]:
            color = COLOR_SET[cursor % color_num]
            cursor += 1
...
def draw(main: Tk, render_canvas: Canvas, render_heart: Heart, render_frame=0):
    ...
    # render_heart.render_multicolor(render_canvas, render_frame)
